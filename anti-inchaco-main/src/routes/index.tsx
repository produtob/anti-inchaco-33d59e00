...
import clickToHear from "@/assets/click-to-hear.jpg.asset.json";
...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      { rel: "preload", as: "image", href: clickToHear.url, fetchpriority: "high" } as any,
      ...
      <header className="relative">
        ...
        <div className="mx-auto max-w-3xl px-4 pt-3 sm:pt-6">
          ...
          <div className="mt-4 overflow-hidden rounded-2xl bg-card shadow-[var(--shadow-soft)] ring-1 ring-border">
            <img src={faceBA.url} alt="Antes e depois — rosto desinchado" className="w-full object-cover" loading="eager" fetchpriority="high" width={800} height={400} />
          ...
          <div className="mt-4 overflow-hidden rounded-2xl bg-card shadow-[var(--shadow-soft)] ring-1 ring-border">
            <img src={bodyTransform.url} alt="Antes e depois — corpo desinchado" className="w-full object-cover" loading="lazy" width={800} height={800} />
            <div className="grid grid-cols-2 border-t border-border text-center text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
              <div className="border-r border-border py-2">Antes</div>
              <div className="py-2 text-[var(--success)]">Depois</div>
            </div>
      ...
      <section className="mx-auto mt-20 max-w-3xl px-4">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="overflow-hidden rounded-3xl bg-card shadow-[var(--shadow-premium)] ring-1 ring-border">
            <img src={faceBA.url} alt="Antes e depois — rosto desinchado" className="w-full object-cover" loading="lazy" width={800} height={400} />
